...
xml.on('endElement: Chemical', function(item) {
  ...
  // classification_list['displayFormula'] = item['$']['displayFormula']
  // classification_list['displayName'] = item['$']['displayName']
  // console.log("DisplayFoirumla : " + item['$']['displayFormula']);
  // console.log("displayName : " + item['$']['displayName']);
  // console.log("id : " + item['$']['id']);

  if(classification_list['id'] == '000050000' && item['ClassificationList']){
    ...
    if(item['ClassificationList']) {
        ...
        for(let i = 0; i < item['ClassificationList']['$children'].length; i++){
          ...
          if(classification_code['$name'] == 'ClassificationCode'){
            console.log(" id : " + classification_list['id'] + " classification code = " + classification_code['$text']);
            //source list
